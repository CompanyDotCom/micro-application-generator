...
export const fetchHandler = async event => useMicroApp(
  AWS,
...
export const directTransitionHandler = async event => useMicroApp(
  AWS,
...
export const bulkFetchHandler = async event => useMicroApp(
  AWS,
...
export const bulkTransitionHandler = async event => useMicroApp(
  AWS,
